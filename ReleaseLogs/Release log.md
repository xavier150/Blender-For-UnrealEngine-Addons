...
- Fixed: Export apply modifiers with that hidden in viewport.
- Fixed: Addon fail to get path when installed in custom script directories.
- Fixed: Addon fail to get version and path when installed as extenton. (Default in Blender 4.2)