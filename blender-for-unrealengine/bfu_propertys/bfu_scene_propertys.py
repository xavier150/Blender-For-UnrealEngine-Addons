...
def register():
    ...
    bpy.types.Scene.bfu_object_lod_properties_expanded = bpy.props.PointerProperty(type=BBPL_UI_ExpendSection, name="Lod")
    bpy.types.Scene.bfu_object_collision_properties_expanded = bpy.props.PointerProperty(type=BBPL_UI_ExpendSection, name="Collision")
    bpy.types.Scene.bfu_object_material_properties_expanded = bpy.props.PointerProperty(type=BBPL_UI_ExpendSection, name="Material")
    bpy.types.Scene.bfu_object_vertex_color_properties_expanded = bpy.props.PointerProperty(type=BBPL_UI_ExpendSection, name="Vertex color")
    bpy.types.Scene.bfu_object_light_map_properties_expanded = bpy.props.PointerProperty(type=BBPL_UI_ExpendSection, name="Light map")
    bpy.types.Scene.bfu_object_uv_map_properties_expanded = bpy.props.PointerProperty(type=BBPL_UI_ExpendSection, name="UV map")

    bpy.types.Scene.bfu_animation_action_properties_expanded = bpy.props.PointerProperty(type=BBPL_UI_ExpendSection, name="Actions Properties")
    bpy.types.Scene.bfu_animation_action_advanced_properties_expanded = bpy.props.PointerProperty(type=BBPL_UI_ExpendSection, name="Actions Advanced Properties")
    bpy.types.Scene.bfu_animation_nla_properties_expanded = bpy.props.PointerProperty(type=BBPL_UI_ExpendSection, name="NLA Properties")
    bpy.types.Scene.bfu_animation_nla_advanced_properties_expanded = bpy.props.PointerProperty(type=BBPL_UI_ExpendSection, name="NLA Advanced Properties")
    ...
    bpy.types.Scene.bfu_collision_socket_expanded = bpy.props.PointerProperty(type=BBPL_UI_ExpendSection, name="Collision and Socket")
    bpy.types.Scene.bfu_lightmap_expanded = bpy.props.PointerProperty(type=BBPL_UI_ExpendSection, name="Light Map")
    bpy.types.Scene.bfu_nomenclature_properties_expanded = bpy.props.PointerProperty(type=BBPL_UI_ExpendSection, name="Nomenclature")
    bpy.types.Scene.bfu_export_filter_properties_expanded = bpy.props.PointerProperty(type=BBPL_UI_ExpendSection, name="Export filters")
    bpy.types.Scene.bfu_export_process_properties_expanded = bpy.props.PointerProperty(type=BBPL_UI_ExpendSection, name="Export process")
    bpy.types.Scene.bfu_script_tool_expanded = bpy.props.PointerProperty(type=BBPL_UI_ExpendSection, name="Copy Import Script")
